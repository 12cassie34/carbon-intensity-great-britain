...
<template>
    <div class='grid grid-cols-1 gap-4 lg:grid-cols-2'>
        <ConditionCard title='Past Half Hour' :card-data='currentHalfHourData.data[0]' />
        ...
        <Card title='Forecast 24 Hours'>
            <template #content>
                <BarChart :svgId="'forecast-24-hours-svg'" :chart-data='formatBarChartData(forecast24HoursData.data, true)'/>
            </template>
        </Card>
    </div>
